...
import { Phone, CheckCircle2, PackageOpen, Truck, AlertCircle, PackageCheck, CheckCircle, MousePointerClick } from "lucide-react";
...
export default function OrderStats({ orders, currentFilter, onFilterChange }: StatsProps) {
  ...
  const statsConfig = useMemo(() => {
    return [
      { 
        ...
        desktopActive: "md:bg-blue-50 md:border-blue-200 md:dark:bg-blue-900/20 md:dark:border-blue-800",
      ...
      { 
        ...
        desktopActive: "md:bg-emerald-50 md:border-emerald-200 md:dark:bg-emerald-900/20 md:dark:border-emerald-800",
      ...
      { 
        ...
        desktopActive: "md:bg-amber-50 md:border-amber-200 md:dark:bg-amber-900/20 md:dark:border-amber-800",
      ...
      { 
        ...
        desktopActive: "md:bg-purple-50 md:border-purple-200 md:dark:bg-purple-900/20 md:dark:border-purple-800",
      ...
      { 
        ...
        desktopActive: "md:bg-teal-50 md:border-teal-200 md:dark:bg-teal-900/20 md:dark:border-teal-800",
      ...
      { 
        ...
        desktopActive: "md:bg-rose-50 md:border-rose-200 md:dark:bg-rose-900/20 md:dark:border-rose-800",
  ...
  const handleScroll = () => {
    if (scrollContainerRef.current) {
      ...
      setActiveIndex(index); // 👈 This now updates the background color immediately on swipe
    }
  };

  // 🟢 FIX: Color matches the VIEWED card, not the SELECTED card (on mobile)
  // This prevents the "Green box, Red text" confusion.
  ...
  return (
    <div className="w-full mb-8">
      ...
      <div className={cn(
        ...
        // Mobile: Background matches the *Viewed* slide
        `${viewedStat.mobileBg} ${viewedStat.mobileBorder}`,
        // Desktop: Reset
        "md:bg-transparent md:border-none md:shadow-none md:overflow-visible md:max-w-none md:mx-0 md:rounded-none"
      )}>
              ...
              >
                ...
                <div className="flex justify-between items-start mb-2">
                  ...
                  {isActive ? (
                    ...
                    // OPTIONAL: "Tap to Select" hint for unselected mobile cards
                ...
                <div className="flex flex-col justify-end h-full">
                  <h4 className={cn(
                    ...
                    isActive ? "md:text-slate-800 md:dark:text-white" : "md:text-slate-700 md:dark:text-slate-200"
                  )}>
                    {currentCount}
                  </h4>
                  <p className={cn(
                    ...
                    card.textColor,
                    isActive ? `md:${card.textColor}` : "md:text-slate-500 md:dark:text-slate-500"
                  )}>
                    {card.label}
                  </p>
          ...
          {statsConfig.map((_, index) => (
            <div
              ...
              className={cn(
                ...
                activeIndex === index 
                  ? `w-6 ${viewedStat.dotColor}` // Color matches current VIEW
