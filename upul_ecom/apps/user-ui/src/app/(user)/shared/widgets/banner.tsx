        ...
        <SwiperSlide className="bg-black w-full h-full">
          <div className="relative h-full w-full text-white font-outfit">
            <div className="absolute inset-0">
              <img
                src="https://images.unsplash.com/photo-1500917293891-ef795e70e1f6?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="Hero Background"
