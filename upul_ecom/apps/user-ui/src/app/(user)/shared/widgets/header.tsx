        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-8">
            ...
            <div className="flex flex-col gap-6 text-xl font-bold uppercase tracking-tighter">
              ...
              <Link href="/blazers" onClick={() => setIsMenuOpen(false)}>
                Blazers
              </Link>
              <Link
                href="/shop?hasDiscount=true"
              ...
              <div className="flex flex-col gap-6">
                {isLoggedIn ? (
                  ...
                  <Link
                    href="/login"
                    onClick={() => setIsMenuOpen(false)}
                    className="flex items-center justify-center w-full bg-black text-white py-4 rounded-sm font-bold uppercase tracking-[0.2em]"
                  >
                    Sign In / Register
                  </Link>
                )}
