                    ...
                    <>
                        ...
                        <form onSubmit={handleSubmit((data) => requestOtpMutation.mutate({ email: data.email }))}>
                            <input type='email' placeholder='E-mail'
                                className='w-full p-4 border border-gray-200 outline-none text-sm placeholder:text-gray-400 focus:border-black transition-colors mb-2'
                        ...
                        <form onSubmit={handleSubmit((data) => resetPasswordMutation.mutate({ password: data.password }))}>
                            <div className="relative mb-2">
                                <input type={passwordVisible ? "text" : "password"} placeholder='New Password'
                                    className='w-full p-4 border border-gray-200 outline-none text-sm placeholder:text-gray-400 focus:border-black'
