  ...
  if (!token) {
      return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4">
            ...
            <Link href="/" className="mt-4 underline text-sm">Return Home</Link>
        </div>
      );
  }
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 md:px-8 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
            <div>
                <span className="text-xs font-bold text-blue-600 uppercase tracking-widest mb-1 block">Live Tracking</span>
            ...
            <div className="text-right">
                {order.trackingNumber && (
                    <div className="bg-white px-5 py-3 rounded-lg border border-gray-200 shadow-sm mb-2">
