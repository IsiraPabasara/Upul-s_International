...
export default function UserOrderDetailsPage() {
  ...
  if (isLoading)
    return (
      <div className="min-h-screen flex items-center justify-center text-xs uppercase tracking-[0.3em] font-bold">
        Loading Details...
      </div>
    );
  ...
  if (error)
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        <p className="text-red-500 mb-4 uppercase tracking-widest font-bold">
          Order not found
        </p>
        <Link
          href="/profile/orders"
          className="underline text-xs font-bold uppercase tracking-widest"
        >
          Back to History
        </Link>
      </div>
